...
#include <utils/lsyscache.h> /* needed for get_attname compat */

/*needed for ExecInitExtraTupleSlot + MakeTupleTableSlot compats*/
 ...
 * PG96 interface is used for compatibility.
 */
#if PG96
 ...
 */
#if PG96 || PG10
static inline  TupleTableSlot * ExecInitExtraTupleSlotCompat(EState *estate, TupleDesc tupdesc) {
...
static inline TupleTableSlot * MakeTupleTableSlotCompat(TupleDesc tupdesc) {
 ...
 */
#if PG96 || PG10
static inline char * get_attname_compat(Oid relid, AttrNumber attnum, bool missing_ok){
 ...
 * add note about parents etc. for future
 */
#if PG96 || PG10
/* Index flags */
 ...
 * Our compat functions act as an accesor/setter for these fields, wheverer they
 * are nested.
 */
